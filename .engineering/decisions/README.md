...
This directory contains ADRs documenting key architectural decisions and their rationale.

## Security

- [ADR: scrypt for Password Hashing](ADR-security-scrypt-hashing.md)
- [ADR: HS256 JWT with Short TTL and JTI Blacklisting](ADR-security-jwt-hs256.md)
