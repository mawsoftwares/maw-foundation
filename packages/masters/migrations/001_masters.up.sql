...
CREATE TABLE IF NOT EXISTS masters (
  ...
  CONSTRAINT masters_tenant_code_unique UNIQUE (tenant_id, code) WHERE (deleted_at IS NULL)
);
...
CREATE TABLE IF NOT EXISTS master_fields (
  ...
  CONSTRAINT master_fields_master_code_unique UNIQUE (master_id, code) WHERE (deleted_at IS NULL)
);
...
CREATE TABLE IF NOT EXISTS master_values (
  ...
  CONSTRAINT master_values_master_code_unique UNIQUE (master_id, code) WHERE (deleted_at IS NULL)
);
